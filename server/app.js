...
// connect to the DB
const dbURI = process.env.MONGODB_URI || 'mongodb+srv://victoriaolivieri:5wAIPI4lVifWWiLL@cluster1.gica3.mongodb.net/olivieri-recipe-data?retryWrites=true&w=majority';
// 'mongodb://127.0.0.1/RecipeMaker';
